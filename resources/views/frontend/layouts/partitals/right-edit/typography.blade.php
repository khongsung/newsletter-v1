	...
	<div id="font-style" class="property radio property__font-style property--full" style="display: block;">
		...
		<div class="fields">
			<div class="field field-radio">
				<div class="radio-items">
					<div class="radio-item">
						<input type="radio" class="radio" id="font-style-normal" name="font-style" value="normal">
						<label class="fa fa-font icon radio-item-label" for="font-style-normal"></label>
					</div>
					<div class="radio-item">
						<input type="radio" class="radio" id="font-style-italic" name="font-style" value="italic">
						<label class="fa fa-italic icon radio-item-label" for="font-style-italic"></label>
					</div>
				</div>
			</div>
		</div>
