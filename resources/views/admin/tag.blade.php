    	...
    	<div class="col-md-12">
    		<div class="box">
                <div class="box-header">
                    <h3 class="box-title">Danh sách thẻ Tag của tôi</h3>
                    <div class="box-tools">
			  	...
			  	<div class="panel panel-default">
			    	<div class="panel-heading">
			      	<h4 class="panel-title">
			        	...
			        	<label class="" style="font-size: 14px; font-weight: 700;line-height: 23px;">Thẻ Tag: {{ $t->name }}, Mô tả: {{$t->description != '' ? $t->description : 'null'}}, ( Số lượng: {{count($t->TemplatePersonal)}}) </label>
			        	</a>
			      	</h4>
			    	</div>
			        		...
			        		<div class="list-group">
								...
								<div class="box-body table-responsive no-padding" style="overflow: unset;">
									<table class="table table-hover table-bordered text-center" >
										...
										@foreach($t->TemplatePersonal as $template)
										<tr>
											<td>#{{$template->id}}</td>
											<td>{{$template->name}}</td>
			...
			@else
			<i  style="padding-left: 10px;">Không có thẻ tag nào</i>
			@endif
		</div> 
	</div>
</section>
